...
export function EditorWorkspace({ projectRoot, fileSystem, projectName, editorSettings, onContextChange, onApplyReady, onDirtyChange, onSaveAllReady }: { projectRoot: string; fileSystem: FileSystemAdapter; projectName: string; editorSettings: import('./types/settings').EditorSettings; onContextChange?: (file: import('./types').OpenFile | null, selection: string) => void; onApplyReady?: (apply: (path: string, content: string) => void) => void; onDirtyChange?: (files: import('./types').OpenFile[]) => void; onSaveAllReady?: (saveAll: () => Promise<void>) => void }) {
